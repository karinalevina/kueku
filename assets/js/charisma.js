$(document).ready(function () {
		//var UrlAddress = 'localhost';
		//var UrlAddress = '10.0.4.164';
		//var UrlAddress = '10.0.4.29';
		//var UrlAddress = '10.0.4.54';
		var UrlAddress = '10.0.4.99';
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', 'http://'+UrlAddress+'/resto/assets/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', 'http://'+UrlAddress+'/resto/assets/css/bootstrap-' + themeName + '.min.css');
        }
